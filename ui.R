...
shinyUI(navbarPage(title="INFO498", theme = "darkly",(
  tabPanel("Home", id="home",
           ...
           p(" The National Youth Physical Activity and Nutrition Study (NYPANS) was conducted by the Centers for Disease Control and Prevention (CDC) in 2010 with three main purposes:
             ...
             measure 24-hour dietary recalls among a subsample of these students. NYPANS used a three-stage cluster sample design to produce a representative sample of
             students in grades 9 through 12. The target population consisted of all public, Catholic, and other private school students in grades 9 through 12. 
             ...
             in the sample. The final, overall weights were scaled so the weighted count of students was equal to the total sample size, and the weighted proportions of students in each grade
             matched population projections for the survey year."),

           p("In the NYPANS data set there were mainly only categorical options to explore, leaving the possibility to extrapolate correlations up to our own discernment.
              Data points were left completely anonymous and unconnected from each other in those specific categories. Studying and utilizing the NYPANS Data 
             Manuel was integral into our understanding of how some questions could be grouped together with other more similar fields in the survey, and could then
